                    ...
                    <div class="mt-6">
                        <div>
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input id="title" name="title" value="{{ $post->title }}" class="p-2 border-solid border border-gray-300 flex-1 form-input block w-full min-w-0 rounded-none rounded-r-md" />
                            </div>
                        </div>
                        ...
                        <div class="pt-4">
                            ...
                            <div class="border-solid border border-gray-300 mt-1 rounded-md shadow-sm">
                                <textarea id="about" name="content" rows="3" class="p-2 form-textarea block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5">{{$post->content}}</textarea>
                            </div>
                        </div>
